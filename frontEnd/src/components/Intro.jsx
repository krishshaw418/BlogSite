...
<div>
  ...
  <h2 className='text-white text-3xl text-center font-serif leading-relaxed max-w-screen-lg mx-auto'>"Inspiring Ideas, Stories, and Strategies for Tomorrow's Leaders."</h2>
